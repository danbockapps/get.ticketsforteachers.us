...
CREATE TABLE `__new_ticket_offers` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`ticket_id` integer NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_ticket_offers`("id", "ticket_id", "user_id", "token", "method", "sent_at", "opened_at", "declined_at") SELECT "id", "ticket_id", "user_id", "token", "method", "sent_at", "opened_at", "declined_at" FROM `ticket_offers`;--> statement-breakpoint
DROP TABLE `ticket_offers`;--> statement-breakpoint
ALTER TABLE `__new_ticket_offers` RENAME TO `ticket_offers`;--> statement-breakpoint
