...
export async function markSent(_prev: MarkSentState, formData: FormData): Promise<MarkSentState> {
  ...
  await logAction(`marked ticket ${ticketId} sent`, distributor)
...
export async function changeStatus(
  ...
  await logAction(`changed ticket ${ticketId} status ${prior} → ${nextStatus}`, distributor)
...
export async function deleteTicket(
  ...
  await logAction(`deleted ticket ${ticketId}`, distributor)
...
export async function restoreTicket(
  ...
  await logAction(`restored ticket ${ticketId}`, distributor)
