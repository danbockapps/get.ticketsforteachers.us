...
[ ] Add domain to register URL and remove create account button from root. In createe account page, put note that peersonal email must not be domain, and work email must be domain. Explain why containing both.
[x] Beef up logging
